 ...
 * A sequence is here a list of itemsets. 
 * Each itemset contains a set of items, where each item is associated to a utility value.
 *
 */
public class SequenceWithUtility {
	 ...
	 * The first list represents the itemsets. 
	 * Each itemset is a list of Double where double values indicate the utility of each item.
	 */
	...
	/**
	 * This mehod creates a sequence with a given id.
